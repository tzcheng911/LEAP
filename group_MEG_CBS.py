...
for s in subj:
    ...
    ## cABR
    dev1=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f80450_evoked_dev1_cabr.fif')[0]
    dev2=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f80450_evoked_dev2_cabr.fif')[0]
    std=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f80450_evoked_substd_cabr.fif')[0]
...
np.save(root_path + 'cbsb_meg_analysis/MEG/cABR/group_ba_f80450_sensor.npy',group_ba)
np.save(root_path + 'cbsb_meg_analysis/MEG/cABR/group_mba_f80450_sensor.npy',group_mba)
np.save(root_path + 'cbsb_meg_analysis/MEG/cABR/group_pa_f80450_sensor.npy',group_pa)
...
for s in subj:
    ...
    stc_std=mne.read_source_estimate(file_in+'_ba_cabr_f80450_morph-vl.stc')
    stc_dev1=mne.read_source_estimate(file_in+'_mba_cabr_f80450_morph-vl.stc')
    stc_dev2=mne.read_source_estimate(file_in+'_pa_cabr_f80450_morph-vl.stc')
