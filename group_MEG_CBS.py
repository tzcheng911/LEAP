...
for s in subj:
    ...
    ## cABR
    dev1=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f_evoked_dev1_ffr_200.fif')[0]
    dev2=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f_evoked_dev2_ffr_200.fif')[0]
    std=mne.read_evokeds(file_in+'_01_otp_raw_sss_proj_f_evoked_substd_ffr_200.fif')[0]
...
np.save(root_path + 'cbsb_meg_analysis/MEG/group_ba_ffr_200_sensor.npy',group_ba)
np.save(root_path + 'cbsb_meg_analysis/MEG/group_mba_ffr_200_sensor.npy',group_mba)
np.save(root_path + 'cbsb_meg_analysis/MEG/group_pa_ffr_200_sensor.npy',group_pa)
...
for s in subj:
    ...
    stc_std=mne.read_source_estimate(file_in+'_ba_ffr_200_morph-vl.stc')
    stc_dev1=mne.read_source_estimate(file_in+'_mba_ffr_200_morph-vl.stc')
    stc_dev2=mne.read_source_estimate(file_in+'_pa_ffr_200_morph-vl.stc')
...
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_ba_ffr_200_morph.npy',group_std)
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_mba_ffr_200_morph.npy',group_dev1)
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_pa_ffr_200_morph.npy',group_dev2)
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_ba_ffr_200_morph_roi.npy',group_std_roi)
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_mba_ffr_200_morph_roi.npy',group_dev1_roi)
np.save(root_path + 'cbsA_meeg_analysis/MEG/FFR/group_pa_ffr_200_morph_roi.npy',group_dev2_roi)
