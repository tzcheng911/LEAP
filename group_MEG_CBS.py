...
np.save(root_path + 'cbsb_meg_analysis/group_mmr1_mba_vector_morph_roi.npy',group_mmr1_roi)
np.save(root_path + 'cbsb_meg_analysis/group_mmr2_pa_vector_morph_roi.npy',group_mmr2_roi)
