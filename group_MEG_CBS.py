...
np.save(root_path + 'cbsb_meg_analysis/group_ba_cabr_morph.npy',group_std)
np.save(root_path + 'cbsb_meg_analysis/group_mba_cabr_morph.npy',group_dev1)
np.save(root_path + 'cbsb_meg_analysis/group_pa_cabr_morph.npy',group_dev2)
np.save(root_path + 'cbsb_meg_analysis/group_ba_cabr_morph_roi.npy',group_std_roi)
np.save(root_path + 'cbsb_meg_analysis/group_mba_cabr_morph_roi.npy',group_dev1_roi)
np.save(root_path + 'cbsb_meg_analysis/group_pa_cabr_morph_roi.npy',group_dev2_roi)
...
# np.save(root_path + 'cbsb_meg_analysis/group_mmr1_mba_vector_morph_mmr-cov.npy',group_mmr1)
# np.save(root_path + 'cbsb_meg_analysis/group_mmr2_pa_vector_morph_mmr-cov.npy',group_mmr2)
