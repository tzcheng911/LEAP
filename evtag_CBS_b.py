...
14. cing_170 ha # raw_file = raw_file.copy().crop(tmax=684)   
                        TTl                  event code
...
time =  '_t3' # '_t1' first time (6 mo) or '_t2' second time (12 mo) or '_t3' third time coming back, or '' for cbs or cing
direction = "ba_to_pa"
...
for n,s in enumerate(subj):
    ...
    # raw_file = raw_file.copy().crop(tmax=684) # for cing_170
