...
def do_sss(subject,st_correlation,int_order,time):
    ...
    'sld_157': ['MEG1043', 'MEG1242'],
    'sld_161': ['MEG1043', 'MEG1242'],
    'sld_163': ['MEG1043', 'MEG1242'],
    'sld_164': ['MEG1043', 'MEG1242']
    }
    ...
    'sld_147': ['MEG2141'],
    'sld_150': ['MEG2533'],
    'sld_153': ['MEG1043','MEG1242'],
    'sld_154': ['MEG1043','MEG1242'],
    'sld_157': ['MEG1043','MEG1242'],
...
for s in subjects:
    ...
    for run in runs:
        ...
        print ('Calculate cov...')
        do_cov(s,raw_erm_filt,time,do_cabr,hp,lp)
        print ('Doing epoch...')
        if do_cabr == True:
